...
<?php>
  ...
  <link href="styles/main_soccer.css" rel="stylesheet" type="text/css" />
  <title>Soccer Data Predictions</title>
  ...
  <header>
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      <a class="navbar-brand"style = "color:white">Soccer Data</a>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="predictions.php">Match Predictions</a>
          </li>
          <li class="nav-item">
